...
public class CosmeticaSettingsScreen extends SulphateScreen {
	public CosmeticaSettingsScreen(Screen parentScreen, ServerOptions oldOptions) {
		super(TextComponents.translatable("cosmetica.cosmeticaSettings"), parentScreen);
	...
	private MutableComponent generateButtonToggleText(String translatable, boolean toggle) {
		MutableComponent component = TextComponents.literal("");
		component.append(TextComponents.translatable(translatable));
		component.append(": ");
		if (toggle) {
